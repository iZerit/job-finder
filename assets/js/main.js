...
const passwordEle2 = document.getElementById('password2');
const toggleEle2 = document.getElementById('toggle2');

toggleEle2.addEventListener('click', function () {
    const type = passwordEle2.getAttribute('type');

    passwordEle2.setAttribute('type',type === 'password' ? 'text' : 'password');
});
...
toggleEle3.addEventListener('click', function () {
